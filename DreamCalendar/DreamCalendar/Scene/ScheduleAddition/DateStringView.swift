...
struct DateStringView: View {
    ...
    init(type: ScheduleAdditionView.SettingState, title: String, defaultTime: TimeInfo, date: Binding<Date>, additionState: Binding<ScheduleAdditionView.SettingState>, tintColor: Color) {
        self.setType = type
        self.title = title
